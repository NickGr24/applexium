/**
 * LiquidEther Background — adapted from ReactBits
 * Navier-Stokes fluid simulation via Three.js WebGL
...
function initLiquidEther(selector, opts) {
  ...
  const { mouseForce, cursorSize, isViscous, viscous, iterationsViscous,
    iterationsPoisson, dt, BFECC, resolution, isBounce, colors,
    autoDemo, autoSpeed, autoIntensity, takeoverDuration,
    autoResumeDelay, autoRampDuration } = options;
